...
python3 -u EP15_Feedable_Iterator_Multiple_Dataset_Initializable_Iterator.py cpu > logs/ep15_cpu.log ;
python3 -u EP15_Feedable_Iterator_Multiple_Dataset_Initializable_Iterator.py gpu > logs/ep15_gpu.log ;

python3 -u EP17_Replace_Placeholder.py cpu > logs/ep17_cpu.log ;
python3 -u EP17_Replace_Placeholder.py gpu > logs/ep17_gpu.log ;

python3 -u EP19_Feedable_Iterator_FetchOP.py cpu > logs/ep19_cpu.log ;
python3 -u EP19_Feedable_Iterator_FetchOP.py gpu > logs/ep19_gpu.log ;
