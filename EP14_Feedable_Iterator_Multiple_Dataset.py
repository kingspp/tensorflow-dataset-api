...
def main():
    ...
    validation_iterator_1 = valid_dataset_1.make_one_shot_iterator()
    validation_iterator_2 = valid_dataset_2.make_one_shot_iterator()
    validation_iterator_3 = valid_dataset_3.make_one_shot_iterator()
    validation_iterator_4 = valid_dataset_4.make_one_shot_iterator()
    validation_iterator_5 = valid_dataset_5.make_one_shot_iterator()
